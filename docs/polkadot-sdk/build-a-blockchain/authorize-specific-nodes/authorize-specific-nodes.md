...
![Authorizing nodes using peer identifier](./four-nodes.png)
...
3. Click **Submit Sudo**.
   ...
   ![Submit a Sudo transaction to add the third node](./sudo-add-well-known-node.png)
...
4. In Authorize transaction, note that the Alice development account is the default root administrative account and used as the `sudo` origin for this call, then click **Sign and Submit**.
   ...
   ![Verify and authorize the transaction](./sudo-to-add-node.png)

5. Click **Network** and select **Explorer** to view the recent transactions.

   ![Verify the Sudo event](./sudo-events-add-node.png)
...
6. Review the transaction details, then click **Sign and Submit**.
   ...
   ![charlie_add_connections](./charlie_add_connections.png)
...
4. Review the transaction details, then click **Sign and Submit**.
   ...
   ![dave_claim_node](./dave_claim_node.png)
...
6. Review the transaction details, then click **Sign and Submit**.
   ...
   ![dave_add_connections](./dave_add_connections.png)
